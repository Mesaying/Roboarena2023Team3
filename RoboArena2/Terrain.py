...
class water(terrain): #inherits from the motherclass terrain and gets the attributes from terrain
    movement = 0.5   #multiplicator how fast the robot move through this terrain
